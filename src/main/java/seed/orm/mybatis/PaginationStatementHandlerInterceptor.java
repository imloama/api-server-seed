...
import seed.orm.dialect.Dialect;
import seed.orm.dialect.DialectFactory;
...
public class PaginationStatementHandlerInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
       ...
       Page<?> page = (Page<?>) rowBounds;
        ...
        // 设置排序字段
        if (page.getOrderStr() != null && page.getOrderStr().length() > 0) {
            originalSql += " order by " + page.getOrderStr();
        }
